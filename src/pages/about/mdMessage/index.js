    ...
    <>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container flex flex-col items-center gap-14">
          ...
          >
            <div className="flex flex-col gap-3 items-start w-1/3 order-1">
              <Image
              ...
              />
              <span>
                <h3 className="text-2xl font-semibold">Gopal Thakuri</h3>
                <p className="text-lg font-medium text-brand1">Managing Director</p>
              </span>
            </div>
