                  ...
                  <div className="mt-2">
                    ...
                    <div className="flex items-center gap-4 mt-3">
                      <button
                        ...
                        className="sm:text-sm text-xs text-white border border-blue-950 bg-blue-950 hover:text-blue-950 hover:bg-white px-2 py-1 cursor-pointer transition-all duration-200 ease-linear"
                      >
                        Apply Now
                      </button>
                      <Link
                        href={`/jobSector/${jobTitle}/${jobItem.country}`}
                        className="sm:text-sm text-xs flex text-white py-1 px-2 bg-brand1 border border-brand1 transition-all duration-200 ease-linear hover:bg-white hover:text-brand1"
                      >
                        View Details
                      </Link>
                    </div>
